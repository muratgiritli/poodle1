      ...
      <main>
        <div className="giz-wrap">
          ...
          <div className="giz-section">
            ...
            <p style={{ marginTop:10 }}>Bu haklarınızı kullanmak için <a href="mailto:info@sizpa.com" style={{ color:"#5D3A1A", fontWeight:700 }}>info@sizpa.com</a> adresine e-posta gönderebilirsiniz. Talepler 30 gün içinde yanıtlanır.</p>
          </div>
