    ...
    >
      <div className="sp-section">
        ...
        <ul>
          ...
          <li>E-posta: <a href="mailto:info@yourpoodle.com" style={{ color:"#7C3AED" }}>info@yourpoodle.com</a></li>
      ...
      <div className="sp-section">
        ...
        <p>Ürünler, sipariş onayından itibaren 1–5 iş günü içinde Alıcının belirttiği adrese kargoya verilir. Teslimat süresi stok durumu ve kargo firmasına göre değişebilir. Ayrıntılar için <a href="/yourpoodle/kargo" style={{ color:"#7C3AED" }}>Kargo ve Teslimat</a> sayfasına bakınız.</p>
      </div>
      ...
      <div className="sp-section">
        ...
        <p>Cayma hakkının kullanılması için <a href="mailto:info@yourpoodle.com" style={{ color:"#7C3AED" }}>info@yourpoodle.com</a> adresine yazılı bildirimde bulunulması yeterlidir.</p>
      ...
      <div className="sp-section">
        ...
        <p>Sipariş sürecinde toplanan kişisel veriler, 6698 sayılı KVKK kapsamında işlenir. Ayrıntılar için <a href="/yourpoodle/gizlilik-politikasi" style={{ color:"#7C3AED" }}>Gizlilik Politikası</a> sayfamıza bakınız.</p>
      </div>
      ...
      <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
        ...
        <a href="/yourpoodle/kullanim-sartlari" className="sp-cta-btn" style={{ background:"#F5F0FF", color:"#7C3AED" }}>Kullanım Koşulları →</a>
      </div>
    </YPStaticPage>
  );
}
