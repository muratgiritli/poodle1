...
/* ─── Footer ─────────────────────────────────────────── */
function BakimFooter({ onNav }:{onNav:(href:string)=>void}) {
  return (
    <footer style={{ background:"#111", padding:"40px 24px 28px" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))", gap:28, marginBottom:28 }}>
          ...
          {[
            { title:"Platform", links:[["Rehber","/yourpoodle/rehber"],["Bakım","/yourpoodle/bakim"],["Sağlık","/yourpoodle/saglik"],["Mağaza","/yourpoodle/magaza"]] },
