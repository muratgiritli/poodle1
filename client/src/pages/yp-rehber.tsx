          ...
          <div style={{ display:"flex", borderTop:"1px solid #f0f0f0" }}>
            {[
              ...
              <button key={t.label} onClick={() => navigate(t.href)}
                style={{ flex:1, padding:"11px 4px", fontSize:13.5, fontWeight: t.label==="Rehber"?700:500, color: t.label==="Rehber"?"#6C47FF":"#555", background:"none", border:"none", borderBottomWidth:"2.5px", borderBottomStyle:"solid", borderBottomColor: t.label==="Rehber"?"#6C47FF":"transparent", cursor:"pointer", fontFamily:"Inter,sans-serif" }}>
                {t.label}
              </button>
            ))}
          </div>
