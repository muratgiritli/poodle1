...
interface AgeOpt {
  ...
  border: string; bg: string; labelColor: string; imgFilter: string;
}
...
interface NeedOpt {
  key: string; label: string; Icon: React.ElementType; iconColor: string; iconBg: string;
}
...
function NeedItem({ opt, selected, onToggle }: {
  ...
  return (
    <button onClick={onToggle}
      ...
      <span style={{ flex:1, fontSize:13, fontWeight:500, color:"#1F2937", lineHeight:1.2 }}>
        {opt.label}
      </span>
