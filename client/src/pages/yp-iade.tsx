  ...
  return (
    ...
    >
      ...
      <div className="sp-section">
        <h2>İade Adımları</h2>
        <ol>
          <li><strong>Talep oluşturun:</strong> <a href="mailto:info@yourpoodle.com" style={{ color:"#7C3AED" }}>info@yourpoodle.com</a> adresine sipariş numaranızı ve iade gerekçenizi yazın.</li>
      ...
      <div className="sp-section">
        ...
        <p>Hasarlı veya yanlış ürün geldiyse iade kargo ücreti tamamen tarafımıza aittir. Fotoğraflı bildirim için <a href="mailto:info@yourpoodle.com" style={{ color:"#7C3AED" }}>info@yourpoodle.com</a> adresine yazın; aynı gün çözüm üretilir.</p>
      </div>

      <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
        <a href="mailto:info@yourpoodle.com" className="sp-cta-btn">İade Talebi Oluştur</a>
        <a href="/yourpoodle/mesafeli-satis" className="sp-cta-btn" style={{ background:"#F5F0FF", color:"#7C3AED" }}>Mesafeli Satış Sözleşmesi →</a>
      </div>
    </YPStaticPage>
  );
}
