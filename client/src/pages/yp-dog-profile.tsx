...
import { ChevronLeft, Share2, Grid3X3, Info, Heart, MessageCircle, Plus } from "lucide-react";
            ...
            <div style={{ display: "flex", background: "#fff", borderBottom: "1px solid #f0f0f0" }}>
              {[
                ...
                <button key={id} onClick={() => setActiveTab(id as any)}
                  style={{ flex: 1, padding: "12px 0", background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 13, fontWeight: 700,
