...
export const TURKEY_CITIES: Record<string, string[]> = {
  ...
  "Burdur": ["Altınyayla","Ağlasun","Burdur Merkez","Bucak","Çavdır","Çeltikçi","Gölhisar","Karamanlı","Kemer","Tefenni","Yeşilova"],
  ...
  "Kars": ["Arpaçay","Digor","Kağızman","Kars Merkez","Sarıkamış","Selim","Susuz"],
  "Kastamonu": ["Abana","Ağlı","Araç","Azdavay","Bozkurt","Çatalzeytin","Cide","Daday","Devrekani","Doğanyurt","Hanönü","İhsangazi","İnebolu","Kastamonu Merkez","Küre","Pınarbaşı","Seydiler","Şenpazar","Taşköprü","Tosya"],
  ...
  "Tokat": ["Almus","Artova","Başçiftlik","Erbaa","Niksar","Pazar","Reşadiye","Tokat Merkez","Turhal","Yeşilyurt","Zile"],
...
export const CITY_LIST = Object.keys(TURKEY_CITIES).sort();
