...
const YP_ROUTE_META: Record<string, YPMeta> = {
  ...
  "/yourpoodle/gizlilik-politikasi": {
    title: "Gizlilik Politikası ve KVKK Aydınlatma Metni | YourPoodle",
    description: "YourPoodle gizlilik politikası ve KVKK kapsamında kişisel verilerinizin nasıl işlendiği, hangi veriler toplandığı ve haklarınız hakkında bilgi.",
    keywords: "yourpoodle gizlilik, kvkk, kişisel veri, gizlilik politikası",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Gizlilik Politikası", href: "/yourpoodle/gizlilik-politikasi" }],
  },
  "/yourpoodle/kullanim-sartlari": {
    title: "Kullanım Koşulları | YourPoodle",
    description: "YourPoodle platformunu kullanmadan önce lütfen kullanım koşullarını okuyun. Üyelik, içerik, ödeme ve sorumluluk şartları.",
    keywords: "yourpoodle kullanım koşulları, kullanım şartları, hizmet sözleşmesi",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Kullanım Koşulları", href: "/yourpoodle/kullanim-sartlari" }],
  },
  "/yourpoodle/sss": {
    title: "Sık Sorulan Sorular | YourPoodle",
    description: "YourPoodle hakkında en çok merak edilenler: sipariş, kargo, iade, üyelik, Club ve AI Asistan sorularına yanıtlar.",
    keywords: "yourpoodle sss, poodle soru cevap, kargo süresi, iade politika",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Sık Sorulan Sorular", href: "/yourpoodle/sss" }],
  },
  "/yourpoodle/kargo": {
    title: "Kargo ve Teslimat Bilgileri | YourPoodle",
    description: "YourPoodle kargo ve teslimat bilgileri: teslimat süreleri, ücretsiz kargo limiti, kargo firmaları ve sipariş takibi.",
    keywords: "yourpoodle kargo, teslimat süresi, ücretsiz kargo, kargo takip",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Kargo ve Teslimat", href: "/yourpoodle/kargo" }],
  },
  "/yourpoodle/uluslararasi-kargo": {
    title: "Uluslararası Kargo | YourPoodle",
    description: "YourPoodle uluslararası gönderim bilgileri: Avrupa, ABD, Körfez ülkeleri ve Asya'ya kargo süreleri, gümrük notu ve minimum sipariş.",
    keywords: "yourpoodle uluslararası kargo, yurt dışı kargo, poodle ürünleri yurt dışı",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Uluslararası Kargo", href: "/yourpoodle/uluslararasi-kargo" }],
  },
  "/yourpoodle/iade": {
    title: "İade ve Değişim Politikası | YourPoodle",
    description: "YourPoodle 14 günlük koşulsuz iade politikası: iade adımları, istisna ürünler ve hasarlı ürün bildirimi.",
    keywords: "yourpoodle iade, değişim, iade politikası, iade süreci",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "İade ve Değişim", href: "/yourpoodle/iade" }],
  },
  "/yourpoodle/guvenli-alisveris": {
    title: "Güvenli Alışveriş | YourPoodle",
    description: "YourPoodle'da güvenli alışveriş: 256-bit SSL şifreleme, 3D Secure ödeme, PCI DSS uyumlu altyapı ve 14 gün iade güvencesi.",
    keywords: "güvenli alışveriş, ssl, 3d secure, pci dss, yourpoodle güvenli ödeme",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Güvenli Alışveriş", href: "/yourpoodle/guvenli-alisveris" }],
  },
  "/yourpoodle/mesafeli-satis": {
    title: "Mesafeli Satış Sözleşmesi | YourPoodle",
    description: "YourPoodle mesafeli satış sözleşmesi: satıcı bilgileri, cayma hakkı, teslimat koşulları ve uyuşmazlık çözümü.",
    keywords: "mesafeli satış sözleşmesi, cayma hakkı, yourpoodle sözleşme",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Mesafeli Satış Sözleşmesi", href: "/yourpoodle/mesafeli-satis" }],
  },
  "/yourpoodle/cerez-politikasi": {
    title: "Çerez Politikası | YourPoodle",
    description: "YourPoodle çerez politikası: kullanılan çerez türleri, amaçları, saklama süreleri ve çerezleri devre dışı bırakma yöntemleri.",
    keywords: "çerez politikası, cookie policy, yourpoodle çerezler",
    schemaType: "guide",
  ...
  "/yourpoodle/kariyer": {
    ...
    keywords: "yourpoodle kariyer, yourpoodle iş ilanı, poodle platform iş",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Kariyer", href: "/yourpoodle/kariyer" }],
  },
  "/yourpoodle/bayi-basvurusu": {
    title: "Bayi Başvurusu | YourPoodle",
    description: "YourPoodle bayi programına katılın: toplu fiyatlandırma, öncelikli stok ve pazarlama desteği avantajları. Online başvuru formu.",
    keywords: "yourpoodle bayi, bayi başvurusu, poodle toplu satış",
    schemaType: "guide",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Bayi Başvurusu", href: "/yourpoodle/bayi-basvurusu" }],
  },
  "/yourpoodle/fotograf-yarismasi": {
    title: "Fotoğraf Yarışması: Sonbahar Poodle 2026 | YourPoodle",
    description: "YourPoodle Sonbahar Poodle Fotoğraf Yarışması: katılım koşulları, ödüller ve son başvuru tarihi. 500 TL ödül kazanın!",
    keywords: "poodle fotoğraf yarışması, yourpoodle yarışma, sonbahar poodle",
    schemaType: "event",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Fotoğraf Yarışması", href: "/yourpoodle/fotograf-yarismasi" }],
  },
  "/yourpoodle/ozel-tasarim": {
    title: "Özel Tasarım Poodle Ürünleri | YourPoodle",
    description: "Poodle'ınız için kişiselleştirilmiş tasma, kıyafet ve aksesuar. Adını yazın, rengini seçin — size özel üretelim.",
    keywords: "poodle özel tasarım, kişiselleştirilmiş poodle, poodle tasma tasarım",
    schemaType: "tool",
    breadcrumb: [{ name: "Ana Sayfa", href: "/" }, { name: "Özel Tasarım", href: "/yourpoodle/ozel-tasarim" }],
  },
};
